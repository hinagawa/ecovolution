const { createPlace, getPlaces, getPlaceById, deletePlaceById, getCoordinates, addEvent, getEventByPlaceId } = require('../controllers/placeController');
...
module.exports = (app) => {
    ...
    app.route('/api/place/getEventByPlaceId').get(getEventByPlaceId);
};
